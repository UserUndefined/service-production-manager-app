...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
            ...
            ngconstant: {
                ...
                development: {
                    constants: {
                        RECEIPT_API_URL: config("development").server.apiUrl
                    }
                },
                qa: {
                    constants: {
                        RECEIPT_API_URL: config("qa").server.apiUrl
                    }
                },
                staging: {
                    constants: {
                        RECEIPT_API_URL: config("staging").server.apiUrl
                    }
                },
                production: {
                    constants: {
                        RECEIPT_API_URL: config("production").server.apiUrl
                    }
                }
            },
            compass: {
